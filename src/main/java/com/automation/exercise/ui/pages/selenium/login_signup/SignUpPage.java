package com.automation.exercise.ui.pages.selenium.login_signup;
...
import com.automation.exercise.ui.pages.selenium.base.BasePage;
...
public class SignUpPage extends BasePage {
    ...
    public void submitCreateAccount() {
        logger.info("Steps: Submitting 'Create Account' form");
    ...
    public SignUpPage fillFormAndClickSubmit(ISignUp user) {
        ...
        logger.info("Steps: Fill form and click submit (negative scenario expected)");
        fillFormSignUp(user);
        fillFormSignUp(user);
        selectCountry(user);
        submitCreateAccount();
    ...
    public CreatedAccountPage fillFormAndCreateAccount(ISignUp user) {
        ...
        logger.info("Steps: Completing full registration process");
        fillFormSignUp(user);
        selectCountry(user);
